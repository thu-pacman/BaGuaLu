...
# Modified by the BaGuaLu-2 contributors for integration with BaGuaLu-2.
...
from transformer_engine.pytorch.module._common import apply_normalization, noop_cat, WeightGradStore
...
from transformer_engine.pytorch.export import is_in_onnx_export_mode, assert_warmed_up
...
class _LayerNormLinear(torch.autograd.Function):
    ...
    def forward(
        ...
        if is_grad_enabled:
            ...
            ctx.tensor_packs = [
                pack_hook(inputmat, op_name="LayerNormLinear"),
            ]
    ...
    def backward(
        ...
        with get_nvtx_range_context("_LayerNormLinear_backward"):
            ...
            inputmat = unpack_hook(ctx.tensor_packs[0])
...
class LayerNormLinear(TransformerEngineBaseModule):
    ...
    def __init__(
        ...
        super(TELayerNormLinear, self).__init__(name)
    ...
    def set_meta_tensor(self, fwd: bool, recipe: Recipe) -> None:
        ...
        super(TELayerNormLinear, self).set_meta_tensor(fwd, recipe)
    ...
    def reset_parameters(self, defer_init=False):
        super(TELayerNormLinear, self).reset_parameters(defer_init=defer_init)
    ...
    def onnx_forward(
        ...
        """
        from transformer_engine.pytorch.export import onnx_layernorm, onnx_gemm
