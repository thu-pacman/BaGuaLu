...
from bgl2.utils import add_python_path

_SCRIPT_DIR = Path(__file__).resolve().parent
add_python_path(_SCRIPT_DIR)
add_python_path(_SCRIPT_DIR / "ext" / "Megatron-LM")
add_python_path(_SCRIPT_DIR / "ext" / "TransformerEngine")

# Apply bgl2's Megatron-LM patches before importing the training entrypoint.
import bgl2.megatron_adaptor  # noqa: F401,E402
