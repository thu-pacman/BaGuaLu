...
from transformer_engine.pytorch.module._common import noop_cat, WeightGradStore
...
class Linear(TransformerEngineBaseModule):
    ...
    def __init__(
        ...
        super(TELinear, self).__init__(name)
    ...
    def set_meta_tensor(self, fwd: bool, recipe: Recipe) -> None:
        ...
        super(TELinear, self).set_meta_tensor(fwd, recipe)
    ...
    def reset_parameters(self, defer_init=False):
        super(TELinear, self).reset_parameters(defer_init=defer_init)
    ...
    def onnx_forward(
        ...
        """
        from transformer_engine.pytorch.export import onnx_gemm
