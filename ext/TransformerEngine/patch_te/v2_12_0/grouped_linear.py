...
class _GroupedLinear(torch.autograd.Function):
    ...
    def forward(
        ...
        *weights_and_biases,
        ...
        if is_grad_enabled:
            ...
            ctx.tensor_packs = [
                pack_hook(inputmat, op_name="GroupedLinear") for inputmat in inputmats
            ]
    ...
    def backward(ctx, grad_output: torch.Tensor) -> Tuple[Union[torch.Tensor, None], ...]:
        ...
        with get_nvtx_range_context("_GroupedLinear_backward"):
            ...
            inputmats = [unpack_hook(tensor_pack) for tensor_pack in ctx.tensor_packs]
...
class GroupedLinear(TransformerEngineBaseModule):
    ...
    def __init__(
        ...
        super(TEGroupedLinear, self).__init__(name)
    ...
    def set_meta_tensor(self, fwd: bool, recipe: Recipe) -> None:
        ...
        super(TEGroupedLinear, self).set_meta_tensor(fwd, recipe)
    ...
    def reset_parameters(self, defer_init=False):
        super(TEGroupedLinear, self).reset_parameters(defer_init=defer_init)
